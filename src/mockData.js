...
const data = {
  gameState: {
    ...
    playerInfo: [{ name: 'Dare', picture: 'todo/pic', player_id: 'sha2' }, { name: 'himmat', picture: 'todo/pic', player_id: 'sha3' },
    { name: 'Megan', picture: 'todo/pic', player_id: 'sha10' }, { name: 'Ryder', picture: 'todo/pic', player_id: 'sha1' }
      , { name: 'Ryder', picture: 'todo/pic', player_id: 'sha1' }
      , { name: 'Ryder', picture: 'todo/pic', player_id: 'sha1' }
      , { name: 'Ryder', picture: 'todo/pic', player_id: 'sha1' }
      , { name: 'Ryder', picture: 'todo/pic', player_id: 'sha1' }
      , { name: 'Ryder', picture: 'todo/pic', player_id: 'sha1' }
