const chatData = [
  ['host', 'Were no strangers to love'],
  ['megan', 'You know the rules and so do I'],
  ['himmat', 'A full commitments what Im thinking of'],
  ['Ryder123', 'Really guys?'],
];
...
const data = {
  gameState: {
    ...
    playerInfo: [
      { name: 'Dare', picture: 'todo/pic' },
      { name: 'Himmat', picture: 'todo/pic' },
      { name: 'Megan', picture: 'todo/pic' },
      { name: 'Ryder', picture: 'todo/pic' },
    ],
    ghostChats: chatData,
